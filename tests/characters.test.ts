...
describe('Characters API', () => {
  ...
  describe('GET /characters', () => {
    ...
    it('should handle server errors and return 500', async () => {
      prismaMock.character.findMany.mockRejectedValue(new Error('Database error'));
  ...
  describe('PATCH /characters/:id', () => {
    ...
    it('should return 400 when no data is provided to update', async () => {
      ...
      expect(response.status).toBe(400);
      expect(response.body).toEqual({ error: 'No data provided to update or invalid.' });
    });
    ...
    it('should return 400 when affiliation name is incorrect', async () => {
      ...
      expect(response.status).toBe(400);
      expect(response.body).toHaveProperty("error", "Invalid affiliation. Name is required.");
    });    
    ...
    it('should handle server errors and return 500 on update', async () => {
      prismaMock.character.findUnique.mockRejectedValue(new Error("Update error"));
  ...
  describe('POST /characters', () => {
    ...
    it('should return 409 when character already exists', async () => {
      ...
      expect(response.body).toEqual({ error: 'Character is already exisiting' });
    });
    ...
    it('should handle server errors and return 500', async () => {
      ...
      prismaMock.affiliation.findUnique.mockRejectedValue(new Error("Database error"));
